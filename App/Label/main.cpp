...
#if KVS_QT_APP
    label.setTextEngine( kvs::qt::TextEngine( QFont( "Monospace", 14 ) ) );
//    label.setTextEngine( kvs::qt::TextEngine( QFont( "Helvatica", 18 ) ) );
//    label.setTextEngine( kvs::qt::TextEngine( QFont( "Meiryo", 18 ) ) );
#endif
    label.setMargin( 10 );
